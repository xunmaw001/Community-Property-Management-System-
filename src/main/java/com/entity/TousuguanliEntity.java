...
public class TousuguanliEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TousuguanliEntity() {
		
	}
	
	public TousuguanliEntity(T t) {
		try {
	 ...
	 * 设置：投诉人员
	 */
	public void setTousurenyuan(String tousurenyuan) {
		this.tousurenyuan = tousurenyuan;
	}
	/**
	 * 获取：投诉人员
	 */
	public String getTousurenyuan() {
		return tousurenyuan;
	}
	/**
	 * 设置：投诉内容
