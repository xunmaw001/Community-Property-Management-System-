    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="楼房名称" prop="loufangmingcheng">
          <el-select v-model="ruleForm.loufangmingcheng" placeholder="请选择楼房名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租楼房" prop="chuzuloufang">
          <el-input v-model="ruleForm.chuzuloufang" 
              placeholder="出租楼房" clearable  :readonly="ro.chuzuloufang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出租楼房" prop="chuzuloufang">
              <el-input v-model="ruleForm.chuzuloufang" 
                placeholder="出租楼房" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="已售楼房" prop="yishouloufang">
          <el-input v-model="ruleForm.yishouloufang" 
              placeholder="已售楼房" clearable  :readonly="ro.yishouloufang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="已售楼房" prop="yishouloufang">
              <el-input v-model="ruleForm.yishouloufang" 
                placeholder="已售楼房" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剩余楼房" prop="shengyuloufang">
          <el-input v-model="ruleForm.shengyuloufang" 
              placeholder="剩余楼房" clearable  :readonly="ro.shengyuloufang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剩余楼房" prop="shengyuloufang">
              <el-input v-model="ruleForm.shengyuloufang" 
                placeholder="剩余楼房" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='chuzuloufang'){
            this.ruleForm.chuzuloufang = obj[o];
	    this.ro.chuzuloufang = true;
            continue;
          }
          if(o=='yishouloufang'){
            this.ruleForm.yishouloufang = obj[o];
	    this.ro.yishouloufang = true;
            continue;
          }
          if(o=='shengyuloufang'){
            this.ruleForm.shengyuloufang = obj[o];
	    this.ro.shengyuloufang = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `loupanguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.loupanguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
