<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="滞纳金" prop="zhinajin">
          <el-input v-model="ruleForm.zhinajin" 
              placeholder="滞纳金" clearable  :readonly="ro.zhinajin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="滞纳金" prop="zhinajin">
              <el-input v-model="ruleForm.zhinajin" 
                placeholder="滞纳金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="还需缴费金额" prop="haixujiaofeijine">
            <el-input v-model="haixujiaofeijine"
                placeholder="还需缴费金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haixujiaofeijine" label="还需缴费金额" prop="haixujiaofeijine">
              <el-input v-model="ruleForm.haixujiaofeijine" 
                placeholder="还需缴费金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    haixujiaofeijine: {
      get: function () {
        return 0+parseFloat(this.ruleForm.qianfeijine==""?0:this.ruleForm.qianfeijine)+parseFloat(this.ruleForm.zhinajin==""?0:this.ruleForm.zhinajin) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qianfeijine = true;
          ...
          if(o=='zhinajin'){
            this.ruleForm.zhinajin = obj[o];
	    this.ro.zhinajin = true;
            continue;
          }
          if(o=='haixujiaofeijine'){
            this.ruleForm.haixujiaofeijine = obj[o];
	    this.ro.haixujiaofeijine = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.haixujiaofeijine = this.haixujiaofeijine
      // ${column.compare}
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qianfeiyezhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qianfeiyezhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
