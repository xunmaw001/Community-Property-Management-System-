<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出入证" prop="churuzheng">
          <el-input v-model="ruleForm.churuzheng" 
              placeholder="出入证" clearable  :readonly="ro.churuzheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出入证" prop="churuzheng">
              <el-input v-model="ruleForm.churuzheng" 
                placeholder="出入证" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车辆单位" prop="cheliangdanwei">
          <el-input v-model="ruleForm.cheliangdanwei" 
              placeholder="车辆单位" clearable  :readonly="ro.cheliangdanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车辆单位" prop="cheliangdanwei">
              <el-input v-model="ruleForm.cheliangdanwei" 
                placeholder="车辆单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="进库时间" prop="jinkushijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jinkushijian" 
                type="date"
                placeholder="进库时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinkushijian" label="进库时间" prop="jinkushijian">
              <el-input v-model="ruleForm.jinkushijian" 
                placeholder="进库时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='churuzheng'){
            this.ruleForm.churuzheng = obj[o];
	    this.ro.churuzheng = true;
            continue;
          }
          if(o=='chepaihao'){
	    ...
	    this.ro.yanse = true;
          ...
          if(o=='cheliangdanwei'){
            this.ruleForm.cheliangdanwei = obj[o];
	    this.ro.cheliangdanwei = true;
            continue;
          }
	    ...
	    this.ro.cheliangzhuangtai = true;
          ...
          if(o=='jinkushijian'){
            this.ruleForm.jinkushijian = obj[o];
	    this.ro.jinkushijian = true;
            continue;
          }
          if(o=='chukushijian'){
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.cheliangzhuangtaiOptions = "入库,出库".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `tingchedengji/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tingchedengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tingchedengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
