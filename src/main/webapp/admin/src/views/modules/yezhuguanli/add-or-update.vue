<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通信地址" prop="tongxindizhi">
          <el-input v-model="ruleForm.tongxindizhi" 
              placeholder="通信地址" clearable  :readonly="ro.tongxindizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通信地址" prop="tongxindizhi">
              <el-input v-model="ruleForm.tongxindizhi" 
                placeholder="通信地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入住楼房号" prop="ruzhuloufanghao">
          <el-input v-model="ruleForm.ruzhuloufanghao" 
              placeholder="入住楼房号" clearable  :readonly="ro.ruzhuloufanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入住楼房号" prop="ruzhuloufanghao">
              <el-input v-model="ruleForm.ruzhuloufanghao" 
                placeholder="入住楼房号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="契约交房日" prop="qiyuejiaofangri">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qiyuejiaofangri" 
                type="datetime"
                placeholder="契约交房日">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiyuejiaofangri" label="契约交房日" prop="qiyuejiaofangri">
              <el-input v-model="ruleForm.qiyuejiaofangri" 
                placeholder="契约交房日" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="紧急联系电话" prop="jinjilianxidianhua">
          <el-input v-model="ruleForm.jinjilianxidianhua" 
              placeholder="紧急联系电话" clearable  :readonly="ro.jinjilianxidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="紧急联系电话" prop="jinjilianxidianhua">
              <el-input v-model="ruleForm.jinjilianxidianhua" 
                placeholder="紧急联系电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	shenfenzheng : false,
	youxiang : false,
	ruzhuloufanghao : false,
	ruzhushijian : false,
	qiyuejiaofangri : false,
	jinjilianxiren : false,
	jinjilianxidianhua : false,
      },
      ruleForm: {
        xingming: '',
        gongzuodanwei: '',
      ...
      rules: {
          ...
          ruzhuloufanghao: [
                { required: true, message: '入住楼房号不能为空', trigger: 'blur' },
          ],
          ruzhushijian: [
          ],
          qiyuejiaofangri: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='tongxindizhi'){
            this.ruleForm.tongxindizhi = obj[o];
	    this.ro.tongxindizhi = true;
            continue;
          }
          if(o=='jiguan'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='ruzhuloufanghao'){
            this.ruleForm.ruzhuloufanghao = obj[o];
	    this.ro.ruzhuloufanghao = true;
            continue;
          }
          if(o=='ruzhushijian'){
	    ...
	    this.ro.ruzhushijian = true;
          ...
          if(o=='qiyuejiaofangri'){
            this.ruleForm.qiyuejiaofangri = obj[o];
	    this.ro.qiyuejiaofangri = true;
            continue;
          }
          if(o=='jinjilianxiren'){
	    ...
	    this.ro.jinjilianxiren = true;
          ...
          if(o=='jinjilianxidianhua'){
            this.ruleForm.jinjilianxidianhua = obj[o];
	    this.ro.jinjilianxidianhua = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yezhuguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yezhuguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
